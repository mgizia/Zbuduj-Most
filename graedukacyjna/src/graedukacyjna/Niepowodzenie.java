 ...
 * Klasa Niepowodzenie rysuje poruszający się obiekt klasy Samochód, jeśli 
 * powodzenie == false
 */
...
public  class Niepowodzenie extends Canvas {
   ...
   private int ax, ay;
    ...
    //okreslony sposob poruszania sie Samochodu, jesli powodzenie == false
        public void rysyjZla(){
            int y = Zasoby.polozenie_y[Zasoby.level];
             ...
             //Samochod zaczyna schodzic pod wode
             while(x<550 & y<300){
               y=y+5;
                punkty.add(new Point(x,y));
                repaint();
